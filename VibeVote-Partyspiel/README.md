...
- 10, 20, 30 oder alle Fragen pro Partie
- geheime und verbindliche Abstimmung, optional mit Selbstwahl
- optionaler Timer mit 20, 25 oder 30 Sekunden
...
- neutrale Alternativen zu Trinkregeln: Punkte oder Aufgaben
...
│   │   └── wording.ts       Trink-, Punkte- und Aufgabenbegriffe
│   ├── server
...
## Zentrale Spielregeln

- Beim Start wird der Fragenpool auf dem Server gemischt und auf die gewählte Rundenzahl begrenzt.
- Jede Person kann genau eine Stimme bestätigen. Die gewählte Zielperson wird erst im aggregierten Rundenergebnis sichtbar.
- Der Host kann auflösen, sobald alle aktuell verbundenen Personen abgestimmt haben. Bei aktivem Timer löst der Server nach Ablauf automatisch auf.
- Die Person mit den meisten Stimmen erhält eine Konsequenz. Bei Gleichstand erhalten alle Personen mit Höchstwert jeweils genau eine.
- Für die Abschlussregel wird die Vereinigungsmenge der ersten und letzten Plätze verwendet. Deshalb wird dieselbe Person nie doppelt berücksichtigt.
