...
export const ESTIMATION_TIMER_OPTIONS = [5, 10, 15, 20, 25, 30, 35, 40] as const;
...
export type EstimationTimerSeconds = typeof ESTIMATION_TIMER_OPTIONS[number];
...
export interface EstimationSettings {
  roundLimit: number;
  timerSeconds: EstimationTimerSeconds;
