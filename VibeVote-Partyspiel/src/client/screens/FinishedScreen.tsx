    ...
    <div className="finished-layout page-enter">
      ...
      <section className="ranking-card glass-card">
        <div className="section-heading ranking-heading">
          <div><span className="section-icon"><Medal size={19} /></span><div><h2>Abschlussrangliste</h2><p>Sortiert nach {wording.countLabel.toLowerCase()}</p></div></div>
        </div>
      ...
      <div className="extreme-cards">
        <div className="extreme-card top-card">
          ...
          <div><small>Die meisten {wording.countLabel}</small><strong>{topNames.join(', ')}</strong></div>
        </div>
        <div className="extreme-card bottom-card">
          <span><Award size={22} /></span>
          <div><small>Die wenigsten {wording.countLabel}</small><strong>{bottomNames.join(', ')}</strong></div>
        </div>
      </div>
      ...
      <section className="final-rule">
        ...
        <div>
          ...
          <p>
            Die Person auf dem ersten Platz und die Person auf dem letzten Platz {wording.finalAction}
