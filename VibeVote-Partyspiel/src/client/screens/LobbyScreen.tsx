    ...
    <div className="room-layout page-enter">
          ...
          <div className="settings-form">
            <fieldset disabled={!isHost}>
              ...
              <div className="segmented-control four-items">
                {([10, 20, 30, 'all'] as const).map((limit) => (
                  <button
                    type="button"
            ...
            <fieldset disabled={!isHost}>
              ...
              <div className="segmented-control four-items">
                {([0, 20, 25, 30] as const).map((seconds) => (
                  <button
                    type="button"
            ...
            <fieldset disabled={!isHost}>
              <legend>Spielregel</legend>
              <select
                value={room.settings.playMode}
                onChange={(event) => void onUpdateSettings({ playMode: event.target.value as RoomSettings['playMode'] })}
              >
                <option value="drink">Trinken / Schluck</option>
                <option value="point">Neutral / Punkt erhalten</option>
                <option value="task">Neutral / Aufgabe erfüllen</option>
              </select>
            </fieldset>
          </div>
        </section>
      ...
      <section className="responsibility-note">
        ...
        <div>
          ...
          <p>Dieses Spiel ist ausschließlich für volljährige Personen bestimmt. Trinkt verantwortungsvoll. Niemand muss Alkohol trinken. Alle Trinkregeln können auch mit alkoholfreien Getränken gespielt werden.</p>
          {isHost && (
