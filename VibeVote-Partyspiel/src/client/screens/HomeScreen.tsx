    ...
    <div className="home-layout page-enter">
      <section className="hero-copy">
        ...
        <div className="feature-row" aria-label="Vorteile">
          ...
          <span><PartyPopper size={17} /> 120 Fragen</span>
      ...
      <p className="responsibility-note compact-note">
        <ShieldCheck size={18} /> Ausschließlich für Volljährige. Niemand muss Alkohol trinken – alle Regeln funktionieren auch alkoholfrei oder als Punktespiel.
      </p>
    </div>
  );
}
