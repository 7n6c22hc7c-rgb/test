...
- **Wer würde eher?** mit 320 Partyfragen, geheimer Abstimmung und gemeinsamen Ergebnissen
- **Schätzfragen** mit 320 Wissens- und Zahlenfragen, Kategorien, Schwierigkeitsstufen und serverseitiger Auswertung
...
- 320 getrennt gepflegte Fragen aus zwölf Kategorien
...
Antworten bleiben bis zur Auflösung geheim. Sobald alle aktuell aktiven Personen geantwortet haben oder der eingestellte Timer abgelaufen ist, zeigt der Server das Ergebnis gleichzeitig auf allen Geräten. Danach bleibt die Ergebnisansicht geöffnet, bis der Host „Nächste Frage“ auswählt. Es gibt keinen automatischen Fragenwechsel.
...
- **5 bis 40 Sekunden Antwortzeit** in 5-Sekunden-Schritten
...
Der Pool enthält genau 320 eindeutige Fragen:

- 54 Fragen in Allgemeinwissen und Geographie sowie je 53 Fragen in Geschichte, Sport, Natur und Kultur
- pro Kategorie 17 schwere sowie 18 bis 19 leichte und 18 mittlere Fragen
...
- 320 eindeutige Schätzfragen und ihre Verteilung
...
- automatische Auflösung nach Ablauf des Schätzfragen-Timers
...
│   ├── server
│   │   ├── games/estimation
│   │   │   ├── estimationQuestions.ts  320 serverseitige Fragen
...
│       ├── questions.ts                 320 „Wer würde eher?“-Fragen
...
```ts
n('geo-m-19', 'Geographie', 'Mittel', 'Wie lang ist ...?', 1234, {
  unit: 'Kilometer',
  allowDecimals: false,
  allowNegative: false,
});
